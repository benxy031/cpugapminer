...
"}\n"
"\n"
/* _MAC5 and montmul_5 are emitted inside #if NL >= 5 below,
 * after DEFINE_GTE(5,5)/DEFINE_SUB(5,5) have been instantiated. */
...
"DEFINE_RMODN(5, 5)\n"
/* Flat named-temporary CIOS montmul for AL=5 -- must follow gte_5/sub_5. */
"#define _MAC5(out, carry_out, a, b, c, old) \\\n"
"    do { ulong _lo = (a)*(b), _hi = mul_hi((a),(b)), _old = (old); \\\n"
"         _lo += (c); _hi += (_lo < (c)); \\\n"
"         (out) = _old + _lo; (carry_out) = _hi + ((out) < _old); } while(0)\n"
"__attribute__((always_inline))\n"
"static inline void montmul_5(__private ulong *r,\n"
"    const __private ulong *a, const __private ulong *b,\n"
"    const __private ulong *n, ulong ninv)\n"
"{\n"
...
"    ulong c, m, _pv;\n"
"    { ulong ai=a[0];\n"
"      _MAC5(t0,c, ai,b[0], 0UL, t0);\n"
"      _MAC5(t1,c, ai,b[1], c,   t1);\n"
"      _MAC5(t2,c, ai,b[2], c,   t2);\n"
"      _MAC5(t3,c, ai,b[3], c,   t3);\n"
"      _MAC5(t4,c, ai,b[4], c,   t4);\n"
"      _pv=t5; t5+=c; t6+=(t5<_pv);\n"
"      m=t0*ninv;\n"
"      _MAC5(t0,c, m,n[0], 0UL, t0);\n"
"      _MAC5(t1,c, m,n[1], c,   t1);\n"
"      _MAC5(t2,c, m,n[2], c,   t2);\n"
"      _MAC5(t3,c, m,n[3], c,   t3);\n"
"      _MAC5(t4,c, m,n[4], c,   t4);\n"
"      _pv=t5; t5+=c; t6+=(t5<_pv);\n"
...
"    ulong tmp[5]; tmp[0]=t0; tmp[1]=t1; tmp[2]=t2; tmp[3]=t3; tmp[4]=t4;\n"
"    if (t5 || gte_5(tmp, n)) sub_5(r, tmp, n);\n"
"    else { r[0]=t0; r[1]=t1; r[2]=t2; r[3]=t3; r[4]=t4; }\n"
"}\n"
"#endif\n"
...
"\n"
/* Fermat kernel: 4-bit left-to-right fixed-window exponentiation.
