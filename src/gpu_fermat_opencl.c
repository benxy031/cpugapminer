...
"\n"
/* Fermat kernel: all calls use AL-specialized functions */
...
"    int msb = 63 - (int)clz((ulong)e[top]); \\\n"
...
"        } \\\n"
"    } \\\n"
"    for (int i = 0; i < (AL); i++) one[i] = 0ul; \\\n"
"    one[0] = 1ul; \\\n"
"    montmul_##AL(res, res, one, n, ninv); \\\n"
"    int ok = (res[0] == 1ul); \\\n"
